...
waitForFrame:
    ...
    LD DE, tile_data    ; RGBDS will replace tile_data with its actual address.
    LD HL, $8000
copyTileData:
...
; byte contains the highest bit for all 8 pixels, the second byte the lowest.
tile_data:
    DB $00, $00 ; Row 0, color 0b00.
    DB $00, $ff ; Row 1, color 0b01.
    DB $ff, $00 ; Row 2, color 0b10.
    DB $ff, $ff ; Row 3, color 0b11.
    DB $00, $00 ; Row 4, color 0b00.
    DB $00, $ff ; Row 5, color 0b01.
    DB $ff, $00 ; Row 6, color 0b10.
